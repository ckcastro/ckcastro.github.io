...
<li>
Evaluate $\iint_D \left( x+2y \right)dA$ where $D$ is the region between $y=x$ and $y=x^2$
</li>
</ul>
</div>
...
&=\int_0^2\left[x^2(2x)+\frac{(2x)^3}{3} -x^2(x^2)-\frac{(x^2)^3}{3}\right]\bigg\vert_{y=x^2}^{y=2x}dx\\
...
<img src="15_2_image14.png" style="width:100%" alt="Diagram of split domain of integration as two regions"><div style="float:left; width:100%">
</div>
</div>
